  ...
  <div class="brisk-main">
        ...
        <el-row :gutter="20">
          ...
          <el-col :xs="24" :sm="12" :md="6">
            <el-form-item label="父级ID" prop="pid">
              <el-input placeholder="父级ID" v-model="searchForm.pid" clearable :style="{ width: '100%' }" />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="6">
            <el-form-item label="组名" prop="name">
              <el-input placeholder="组名" v-model="searchForm.name" clearable :style="{ width: '100%' }" />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="6">
      ...
      <template #form>
        <el-form ref="addForm" :model="addForm" label-width="80px" label-position="left" size="medium">
          <el-form-item label="组名">
            <el-input v-model="addForm.name" :placeholder="组名"></el-input>
          </el-form-item>
    ...
    <div style="flex: 1">
      <el-table ref="tables" v-loading="loadingStatus" :data="tableData" @selection-change="selectionChange" border stripe row-key="id" default-expand-all :tree-props="{children: 'children'}" style="width: 100%">
        ...
        <el-table-column v-if="showColumns.name" prop="name" label="组名" min-width="180"></el-table-column>
    ...
    <briskDialogcom title="编辑" :device="$store.state.app.device" :showDialog="editDialogFormVisible" @cancle="editCancle" @submit="editSubmit" @close="editCancle">
      <template #form>
        <el-form ref="editForm" :model="editForm" label-width="80px" label-position="left" size="medium">
          <el-form-item label="组名">
            <el-input v-model="editForm.name" placeholder="组名"></el-input>
          </el-form-item>
          <el-form-item label="父级ID">
